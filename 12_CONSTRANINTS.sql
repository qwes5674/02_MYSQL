...
-- 테이블 전체삭제
drop table if exists tbl_country, tbl_test,tbl_tets2,user_check,user_foreignkey1,user_grade,user_notnull,user_primarykey,user_unique;
...
-- 한 개의 컬럼에 설정할 수 도 있고, 여러 개의 컬럼을 묶어서 설정 할 수도 있다.(복합키)
